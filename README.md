...
## 0x00 安装
```
wget --tries=5 -c -t 60 -O- https://fastly.jsdelivr.net/gh/CH3NGYZ/tailscale-openwrt@chinese_mainland/install.sh | sh
```
...
```
wget --tries=5 -c -t 60 -O- https://fastly.jsdelivr.net/gh/CH3NGYZ/tailscale-openwrt@chinese_mainland/uninstall.sh | sh
```
------------
## 0x02 升级
