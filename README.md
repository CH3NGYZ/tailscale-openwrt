...
## 0x00 安装
```
wget -O- https://jsdelivr.b-cdn.net/gh/CH3NGYZ/tailscale-openwrt@chinese_mainland/install.sh | sh
```
...
```
wget -O- https://jsdelivr.b-cdn.net/gh/CH3NGYZ/tailscale-openwrt@chinese_mainland/uninstall.sh | sh
```
------------
## 0x02 升级
